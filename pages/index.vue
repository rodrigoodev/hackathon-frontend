...
<div class="container" id="container">
        ...
        <div class="form-container sign-in-container">
             <form class="form-login"  @submit.prevent="signIn">
                <h1>Entrar</h1>
                <input v-model="signInData.email" type="email" name="email" placeholder="Entre com seu email" required>
                <input v-model="signInData.password" type="password" name="password" placeholder="Entre com sua senha" required>
...
export default {
  ...
  methods: {
    signIn() {
      console.log('Login attempt with email:', this.signInData.email, 'and password:', this.signInData.password);
    },
    signUp() {
      console.log('name:', this.signUpData.name, 'email:', this.signUpData.email, 'and password:', this.signUpData.password);
    }
  },
  mounted() {
